			...
			if (!isset($footer_parallax) || ($footer_parallax === false) || $footer_parallax == '' || $footer_parallax == '-1') {
			...
			if (!isset($footer_wrapper_layout) || ($footer_wrapper_layout === false) || $footer_wrapper_layout == '' || $footer_wrapper_layout == '-1') {
			...
			if (!isset($collapse_footer) || ($collapse_footer === false) || $collapse_footer == '' || $collapse_footer == '-1') {
			...
			if (!isset($footer_scheme) || ($footer_scheme === false) || $footer_scheme == '' || $footer_scheme == '-1') {
			...
			if (!isset($footer_show_hide) || ($footer_show_hide === false) || ($footer_show_hide=='-1') || ($footer_show_hide==='')) {
				$footer_show_hide = '1';
			}
			?>
