<?php
    ...
    if (!in_array($archive_display_type, array('list','grid'))) {
    ...
    if (!in_array($archive_display_columns, array('2','3','4','5'))) {
	...
	switch ($archive_display_type) {
		case 'list':
			$g5plus_archive_loop['image-size'] = 'blog-list-image';
			if ($content_col_number < 12) {
				$g5plus_archive_loop['image-size'] = 'blog-list-image-sidebar';
			}
			break;
		case 'grid':
			$g5plus_archive_loop['image-size'] = 'blog-grid-image';
			if ($content_col_number < 12) {
				$g5plus_archive_loop['image-size'] = 'blog-grid-image';
			}
			break;
		...
		<?php endif;?>
				...
				<div class="site-content-archive-inner <?php echo esc_attr($content_col) ?>">
					<div class="<?php echo join(' ',$blog_wrap_class); ?>">
						...
						?>
							<div class="blog-paging-<?php echo esc_attr($archive_paging_style); ?>">
								<?php
