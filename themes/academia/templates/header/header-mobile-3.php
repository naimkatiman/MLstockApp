...
if (($mobile_header_menu_drop === false) || ($mobile_header_menu_drop === '') || ($mobile_header_menu_drop == '-1')) {
...
if (($mobile_header_stick === false) || ($mobile_header_stick === '') || ($mobile_header_stick == '-1')) {
