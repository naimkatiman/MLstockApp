...
$prefix = 'g5plus_';
$show_page_title = isset($g5plus_options['show_archive_event_title']) ? $g5plus_options['show_archive_event_title'] : '1';
if ($show_page_title == 0) return;

$page_title_style = isset($g5plus_options['style_archive_event_title']) ? $g5plus_options['style_archive_event_title'] : '';

// Page Title Text Align
$page_title_text_align = isset($g5plus_options['archive_event_title_text_align']) ? $g5plus_options['archive_event_title_text_align'] : 'center';
...
if (empty($page_sub_title)) {
    $page_sub_title = isset($g5plus_options['archive_event_sub_title']) ? $g5plus_options['archive_event_sub_title'] : '';
}

$custom_styles = array();
$page_title_wrap_class = array('archive-event-title-wrap');
$page_title_inner_class = array('archive-event-title-inner');
$page_title_inner_class[] = $page_title_style;
if(!empty($page_title_text_align)){
    $page_title_inner_class[] = $page_title_text_align;
}
...
if(!$page_title_bg_image || ($page_title_bg_image === '')) {
    $page_title_bg_image = $g5plus_options['archive_event_title_bg_image'];
}
...
$page_title_wrap_class[] = 'archive-event-title-margin';
...
if (!empty($page_title_bg_image_url)) {
    $page_title_parallax = isset($g5plus_options['archive_event_title_parallax']) ? $g5plus_options['archive_event_title_parallax'] : '0';
    if ($page_title_parallax == 1) {
        $page_title_parallax_position = isset($g5plus_options['archive_event_title_parallax_position']) ? $g5plus_options['archive_event_title_parallax_position'] : 'top';
    }
}
...
<section id="page-title" class="<?php echo join(' ', $page_title_wrap_class); ?>" <?php echo wp_kses_post($custom_style); ?>>
    ...
    <div class="container">
        <div class="<?php echo join(' ',$page_title_inner_class); ?>">
            <div class="m-title">
                <h2 class="p-font"><?php esc_html_e('Event','g5plus-academia'); ?></h2>
