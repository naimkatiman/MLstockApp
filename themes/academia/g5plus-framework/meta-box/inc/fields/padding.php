	...
	class RWMB_Padding_Field extends RWMB_Field {
		...
		static function html( $meta, $field )
		{
			...
			$padding_config = array(
				'top'       => array(
					'icon' => 'fa fa-arrow-up',
					'label' => esc_html__('Top','g5plus-academia')
				),
				'bottom'       => array(
					'icon' => 'fa fa-arrow-down',
					'label' => esc_html__('Bottom','g5plus-academia')
				),
				'left'       => array(
					'icon' => 'fa fa-arrow-left',
					'label' => esc_html__('Left','g5plus-academia')
				),
				'right'       => array(
					'icon' => 'fa fa-arrow-right',
					'label' => esc_html__('Right','g5plus-academia')
				),
			);
