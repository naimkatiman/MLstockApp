						...
						while ( have_posts() ) : the_post();
							...
							the_post_navigation( array(
								'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Next', 'univero' ) . '</span> ' .
									'<span class="pull-right navi">' . esc_html__( 'Next post:', 'univero' ) . '</span> ' .
									'<span class="post-title">%title</span>',
								'prev_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Previous', 'univero' ) . '</span> ' .
									'<span class="pull-left navi">' . esc_html__( 'Previous post:', 'univero' ) . '</span> ' .
									'<span class="post-title">%title</span>',
							) );

							if ( univero_get_config('show_blog_releated', true) ): ?>
