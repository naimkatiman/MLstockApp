...
<div class="ninzio-social-share">
		...
		<li class="hide"><span><?php esc_html_e('Share this product', 'univero'); ?></span></li>
		...
		<?php if ( univero_get_config('google_share', 1) ): ?>
			...
			<li>
				<a class="bo-social-facebook google" data-toggle="tooltip" data-placement="<?php echo esc_attr($args['position']); ?>" data-animation="<?php echo esc_attr($args['animation']); ?>"  data-original-title="Google plus" href="https://plus.google.com/share?url=<?php the_permalink(); ?>" onclick="javascript:window.open(this.href,
