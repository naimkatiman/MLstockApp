...
class Univero_Recent_Post extends Ninzio_Widget {
    public function __construct() {
        parent::__construct(
            'ninzio_recent_post',
            esc_html__('Ninzio Recent Posts Widget', 'univero'),
            array( 'description' => esc_html__( 'Show list of recent post', 'univero' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'univero' ); ?></label>
...
univero_reg_widget( 'Univero_Recent_Post' );