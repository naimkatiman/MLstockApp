...
class Univero_Socials_Widget extends Ninzio_Widget {
    public function __construct() {
        parent::__construct(
            'ninzio_socials_widget',
            esc_html__('Ninzio Socials', 'univero'),
            array( 'description' => esc_html__( 'Socials for website.', 'univero' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'univero-script-admin-js', get_template_directory_uri().'/js/admin/admin.js', array( 'jquery' ), NINZIO_FRAMEWORK_VERSION, true );
    }
    ...
    <div class="ninzio_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'univero'); ?></label>
            <br>
        <?php
...
univero_reg_widget( 'Univero_Socials_Widget' );